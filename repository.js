...
Lootr.Repository.prototype.define = function(name, template) {
    this._templates[name] = template;
};


// Create an object based on a template.
Lootr.Repository.prototype.create = function(name) {
...
Lootr.Repository.prototype.createRandom = function() {
